    ...
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <main className="max-w-400 px-10 w-full">
                <section className="w-full min-h-screen justify-between gap-y-10 pt-50 pb-10 items-center flex flex-col">
                    <div className="gap-y-10 py-10 justify-center items-center flex flex-col">
                        ...
                        <button
                            className="flex bg-[#FFF] text-black rounded-xs px-10 font-semibold py-2 text-xs gap-x-5 uppercase">
                            sign up
                        </button>
            ...
            <section
                ...
                <div className="px-10 max-w-400 w-full">
            ...
            <section
                className="w-full h-[60vh] bg-black justify-between items-center gap-y-20 pt-10 pb-10 flex flex-col">
                <div className="px-10 max-w-400 w-full">
                    <p className="gap-y-10 text-6xl text-white py-10  w-full  flex flex-col">
                        Features
                    </p>
                </div>
                <div className="px-10 gap-x-10 pb-10 gap-y-5 font-space grid max-md:grid-cols-1 grid-cols-3 max-w-400 w-full">
                    <div className="border-4 border-white flex items-end  pt-20 rounded-xl p-5 text-2xl sm:text-3xl lg:text-4xl xl:text-5xl">
